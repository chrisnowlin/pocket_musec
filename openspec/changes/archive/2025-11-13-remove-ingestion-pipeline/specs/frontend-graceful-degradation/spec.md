...
**Reason**: Ingestion pipeline is being completely removed.
**Migration**: UI elements remain but become non-functional.

### Requirement: Document classification display
**Reason**: Ingestion pipeline is being completely removed.
**Migration**: UI elements remain but show unavailable status.

### Requirement: Ingestion progress tracking
**Reason**: Ingestion pipeline is being completely removed.
**Migration**: Progress indicators show unavailable status.

### Requirement: Ingestion results display
**Reason**: Ingestion pipeline is being completely removed.
**Migration**: Results panels show unavailable message.